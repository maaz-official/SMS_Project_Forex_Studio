...
const ChooseSubject = ({ situation }) => {
    ...
    if (loading) {
        ...
        return (
            <div>
                <h1>معذرت، تمام مضامین پہلے ہی اساتذہ کو تفویض کیے جا چکے ہیں۔</h1>
                    ...
                    <Table aria-label="sclasses table">
                        <TableHead>
                            <StyledTableRow>
                                ...
                                <StyledTableCell align="center">مضمون کا نام</StyledTableCell>
                                <StyledTableCell align="center">مضمون کا کوڈ</StyledTableCell>
                                <StyledTableCell align="center">عمل</StyledTableCell>
                            </StyledTableRow>
                        </TableHead>
                        <TableBody>
