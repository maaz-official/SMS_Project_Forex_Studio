...
const ViewStudent = () => {
    ...
    const deleteHandler = () => {
        setMessage("معذرت، حذف کی خصوصیت اس وقت غیر فعال ہے۔");
        setShowPopup(true);
        ...
        const renderTableSection = () => {
            return (
                <>
                    ...
                    <Table>
                        <TableHead>
                            <StyledTableRow>
                                ...
                                <StyledTableCell>حاضری کی شرح</StyledTableCell>
                                <StyledTableCell align="center">اعمال</StyledTableCell>
                            </StyledTableRow>
                        </TableHead>
                    ...
                    <div>
                        کل حاضری کی شرح: {overallAttendancePercentage.toFixed(2)}%
                    </div>
                    <Button variant="contained" color="error" startIcon={<DeleteIcon />} onClick={() => removeHandler(studentID, "RemoveStudentAtten")}>تمام حذف کریں</Button>
                ...
                <>
                    ...
                    <Table>
                        <TableHead>
                            <StyledTableRow>
                                <StyledTableCell>مضمون</StyledTableCell>
                                <StyledTableCell>نمبر</StyledTableCell>
                            </StyledTableRow>
                        </TableHead>
                        <TableBody>
                        ...
                        <TabContext value={value}>
                            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                                <TabList onChange={handleChange} sx={{ position: 'fixed', width: '100%', bgcolor: 'background.paper', zIndex: 1 }}>
                                    ...
                                    <Tab label="حاضری" value="2" />
                                    <Tab label="نمبر" value="3" />
                                </TabList>
                            </Box>
