...
const ShowNotices = () => {
    ...
    const noticeColumns = [
        ...
        { id: 'details', label: 'تفصیلات', minWidth: 100 },
        { id: 'date', label: 'تاریخ', minWidth: 170 },
    ];
    ...
    const actions = [
        {
            icon: <NoteAddIcon color="primary" />, name: 'نیا نوٹس شامل کریں',
            action: () => navigate("/Admin/addnotice")
        },
        {
            icon: <DeleteIcon color="error" />, name: 'تمام نوٹس حذف کریں',
